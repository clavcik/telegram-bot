...
token = os.getenv("8321577382:AAF8sPv8N41WUk1Sa8ZMbPIn6sQznkGzk6Q")
...
# --- Список всех команд ---
all_commands = {
    "обнять": "🤗", "поцеловать": "💋", "дать пять": "🖐️", "испугаться": "😱", "извиниться": "🙏", "куснуть": "🦷",
        ...
        for command in all_commands.keys():
            ...
            if normalized_command in normalized_text:
                ...
                if normalized_command in words:
                    matched_command = command  # Сохраняем оригинальную команду с ё
                    break
